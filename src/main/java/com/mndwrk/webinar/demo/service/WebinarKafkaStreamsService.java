...
public class WebinarKafkaStreamsService {
    ...
    @Autowired
    public void stream(final StreamsBuilder builder) {
    ...
    public void table(final StreamsBuilder builder) {
        ...
        final KTable<String, ConsumedEvent> table = builder.table(KafkaConfig.KAFKA_INBOUND_TOPIC_NAME, Consumed.with(keySerde, consumedValueSerde));
